...
const HeroSection = () => {
  return (
    <section
      className="min-h-screen flex items-center px-5 md:px-10 lg:px-16 xl:px-36 relative overflow-hidden"
      style={{
        background:
      ...
      <div className="max-w-screen sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-7xl 3xl:max-w-[1440px] relative z-20 pt-10 md:pt-24 3xl:mx-auto">
        ...
        <ScrollRevealText className="text-lg md:text-xl max-w-lg md:max-w-2xl lg:max-w-3xl xl:max-w-4xl 3xl:max-w-5xl leading-relaxed">
          ...
          <a
            ...
            className="mt-3 px-7 py-3 border-2 border-white font-medium rounded-full transition-all duration-200 hover:bg-white hover:text-[#1f0c20] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white/50 shadow-lg shadow-white/20 hover:shadow-white/30 inline-block text-center"
          >
            TALK TO US
          </a>
        </ScrollRevealText>
